...
This repo is the **agent-comms** component of AgentEco, governed by Architecture-Above-Code.
...
**While working:** you may write only to `components/agent-comms/**`, an additive
...
need something owned elsewhere, ask for it in `components/agent-comms/docs/needs/`.
...
`atlas/agent-comms/<topic>`, open the PR).
